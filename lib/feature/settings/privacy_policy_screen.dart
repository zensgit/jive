        ...
        child: Column(
          ...
          children: [
            ...
            _Section(
              title: '5. 数据安全',
              content:
                  '• 我们在支持的云同步与服务接口中尽量使用加密传输；用户自定义 WebDAV 或其他远程目标的传输安全取决于其自身协议与配置\n'
                  '• 支持 PIN 码和手势图案锁保护应用\n'
                  '• 支持加密备份导出\n'
                  '• 我们定期审查安全措施',
            ),
            ...
            _Section(
              ...
              content:
                  ...
                  '• 退出登录并以游客模式继续使用；账户删除和云端数据清理能力可能受当前服务配置限制\n'
                  '• 关闭云同步，仅使用本地模式',
            ),

            _Section(
              title: '7. 儿童隐私',
              content: '本应用不面向13岁以下儿童。我们不会故意收集儿童的个人信息。',
            ),

            _Section(
              title: '8. 政策变更',
              content: '我们可能会不时更新本隐私政策。变更将在应用内通知。继续使用本应用即表示接受更新后的政策。',
            ),
