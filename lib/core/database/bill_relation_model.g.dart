...
void _jiveBillRelationSerialize(
  ...
  writer.writeString(offsets[7], object.relationType);
  writer.writeDateTime(offsets[8], object.settledAt);
  writer.writeLong(offsets[9], object.sourceTransactionId);
...
JiveBillRelation _jiveBillRelationDeserialize(
  ...
  object.linkedTransactionId = reader.readLong(offsets[5]);
  object.note = reader.readStringOrNull(offsets[6]);
  object.relationType = reader.readString(offsets[7]);
  object.settledAt = reader.readDateTimeOrNull(offsets[8]);
  object.sourceTransactionId = reader.readLong(offsets[9]);
...
extension JiveBillRelationQueryProperty
  ...
  QueryBuilder<JiveBillRelation, bool, QQueryOperations> isSettledProperty() {
    return QueryBuilder.apply(this, (query) {
