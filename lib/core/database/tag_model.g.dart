...
extension JiveTagByIndex on IsarCollection<JiveTag> {
  Future<JiveTag?> getByName(String name) {
    return getByIndex(r'name', [name]);
  }

  JiveTag? getByNameSync(String name) {
  ...
  Future<List<JiveTag?>> getAllByName(List<String> nameValues) {
    final values = nameValues.map((e) => [e]).toList();
    return getAllByIndex(r'name', values);
  }

  List<JiveTag?> getAllByNameSync(List<String> nameValues) {
    final values = nameValues.map((e) => [e]).toList();
  ...
  Future<Id> putByName(JiveTag object) {
    return putByIndex(r'name', object);
  }

  Id putByNameSync(JiveTag object, {bool saveLinks = true}) {
    return putByIndexSync(r'name', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByName(List<JiveTag> objects) {
    return putAllByIndex(r'name', objects);
  }

  List<Id> putAllByNameSync(List<JiveTag> objects, {bool saveLinks = true}) {
...
extension JiveTagQueryWhere on QueryBuilder<JiveTag, JiveTag, QWhereClause> {
  ...
  QueryBuilder<JiveTag, JiveTag, QAfterWhereClause> nameEqualTo(String name) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<JiveTag, JiveTag, QAfterWhereClause> nameNotEqualTo(
      String name) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension JiveTagQueryFilter
  ...
  QueryBuilder<JiveTag, JiveTag, QAfterFilterCondition> isHiddenEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isHidden',
...
extension JiveTagQuerySortBy on QueryBuilder<JiveTag, JiveTag, QSortBy> {
  ...
  QueryBuilder<JiveTag, JiveTag, QAfterSortBy> sortByIsHidden() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isHidden', Sort.asc);
    });
  }

  QueryBuilder<JiveTag, JiveTag, QAfterSortBy> sortByIsHiddenDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension JiveTagQuerySortThenBy
  ...
  QueryBuilder<JiveTag, JiveTag, QAfterSortBy> thenByIsHidden() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isHidden', Sort.asc);
    });
  }

  QueryBuilder<JiveTag, JiveTag, QAfterSortBy> thenByIsHiddenDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isHidden', Sort.desc);
    });
  }
...
extension JiveTagQueryWhereDistinct
  ...
  QueryBuilder<JiveTag, JiveTag, QDistinct> distinctByIsHidden() {
    return QueryBuilder.apply(this, (query) {
...
extension JiveTagQueryProperty
  ...
  QueryBuilder<JiveTag, bool, QQueryOperations> isHiddenProperty() {
    return QueryBuilder.apply(this, (query) {
