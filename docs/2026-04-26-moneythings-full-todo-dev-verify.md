...
- 2026-05-07：PR #243 / `codex/moneythings-tag-merge-warnings` 为共享场景的标签合并补齐二次确认，提示交易和智能规则会迁移到目标标签且 source tag 会被删除；私有场景保持原合并行为。
...
- `docs/2026-05-07-moneythings-tag-merge-warnings-dev-verify.md`
